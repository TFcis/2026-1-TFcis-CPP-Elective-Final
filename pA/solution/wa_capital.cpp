// WA #5: outputs the two error words in the wrong case ("IMPOSSIBLE" /
// "AMBIGUOUS" instead of "Impossible" / "Ambiguous"). Catches solutions that
// didn't read the spec carefully.
#include <bits/stdc++.h>
using namespace std;
