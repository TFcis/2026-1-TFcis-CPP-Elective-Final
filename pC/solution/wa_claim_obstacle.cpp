// WA: forgets that '#' blocks expansion -- treats obstacle cells as if they
// were empty, so slimes happily claim them and count them as occupied.
...
int main() {
	...
	// BUG: '#' cells initialized as EMP instead of OBS.
